...
function ScrollCarousel({ children }) {
  ...
  const onMouseMove = useCallback(
    ({ clientX: x, clientY: y }) => set({ xy: [x - _window?.innerWidth / 2, y - _window?.innerHeight / 2] }),
    ...
    <div onMouseMove={onMouseMove} className="scroll-carousel" ref={refHeight} style={{ height: elHeight }}>
      <div className="sticky top-0 ">
        <div className="max-w-2xl px-4 pt-8 mx-auto text-center">
          <h2 className="mt-2 text-white heading-bold">Make ScaleApps life easier </h2>
